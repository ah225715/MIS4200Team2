...
namespace MIS4200Team2.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            ViewBag.Message = "At Cintas we have given a lot of thought to the Corporate Character we want to exhibit. This character includes: ";
            ...
            ViewBag.Six = "6. We are humble and respect all partners. Everyone at Cintas is making a vital contribution to our success. We recognize the potential in every human being and are careful to involve everyone. We want each partner to be a confident, contributing member of the team.";
